...
using System.Linq;
using System.Text;
using IntegracaoVindi.API.Data.Base;
using IntegracaoVindi.API.Model;


namespace IntegracaoVindi.API.Data.Repository
{
 ...
 //   {
	...
	//			command = new SqlCommand($"select *from Customers WHERE UserID = @UserID");
	//			command.Parameters.AddWithValue("userID", userID.AsDbValue());
